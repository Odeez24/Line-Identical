...
//      par la fonction ds_empty et non révoquée par la
//      fonction ds_dispose ;
...
//  ds_dispose : Libère les ressources allouées à la gestion du tableau
//    dynamique associé à *aptr puis affecte NULL à *aptr.
//    Sans effet, si *aptr vaut NULL,
extern void ds_dispose(ds **aptr);

//  ds_add : Ajoute le caractère s selon la méthode de l'ajout en bout de
//    chemin
